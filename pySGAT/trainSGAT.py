...
t_total = time.time()
loss_values = []
trainloss_SGAT_cora,valloss_SGAT_cora=[],[]
trainacc_SGAT_cora,valacc_SGAT_cora=[],[]
bad_counter = 0
best = args.epochs + 1
best_epoch = 0
for epoch in range(args.epochs):
    trainloss,valloss,trainacc,valacc=train(epoch)
    # loss_values.append(train(epoch))
    trainloss_SGAT_cora.append(trainloss)
    valloss_SGAT_cora.append(valloss)
    trainacc_SGAT_cora.append(trainacc)
    valacc_SGAT_cora.append(valacc)
